...
class CoreAPI {
    ...
    scan(options){
        ...
        return new Promise(function (resolve, reject) {
            axios.post(this.apiendpoint, payload, {timeout: 60}).then(function (response) {
                resolve(response);
...
class DocuPass {
    ...
    _create(docupass_module){
        ...
        return new Promise(function (resolve, reject) {
            axios.post(this.apiendpoint +"docupass/create", payload, {timeout: 15}).then(function (response) {
                resolve(response);
            }).catch(function (error) {
                if (error.response) {
                    reject(new Error('Connecting to API Server failed: HTTP '+  response.status));
    ...
    validate(reference, hash){
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios.post(this.apiendpoint +"docupass/validate", payload, {timeout: 15}).then(function (response) {
...
class Vault {
    ...
    _callAPI(action, payload = {}){
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios.post(this.apiendpoint + "vault/" + action, payload, {timeout: 60}).then(function (response) {
                if(response.error){
