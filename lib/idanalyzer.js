    ...
    scan(options){
        ...
        return new Promise(function (resolve, reject) {
            ...
            fetch(this.apiendpoint, {
                ...
                reject(new Error('Connecting to API Server failed: '+  error.text()));
            });
...
class DocuPass {
    ...
    _create(docupass_module){
        ...
        return new Promise(function (resolve, reject) {
            ...
            fetch(this.apiendpoint +"docupass/create", {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    validate(reference, hash){
        ...
        return new Promise(function (resolve, reject) {
            ...
            fetch(this.apiendpoint +"docupass/validate", {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
class Vault {
    ...
    _callAPI(action, payload = {}){
        ...
        return new Promise(function (resolve, reject) {
            ...
            fetch(this.apiendpoint + "vault/" + action, {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                ...
                if(responseJson['error']){
                    reject(new Error(responseJson['error']['code']+": "+responseJson['error']['message']));
                }else{
                    return responseJson;
                }
            }).catch((error) => {
